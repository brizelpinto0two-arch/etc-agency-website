    ...
    <section className="relative min-h-screen w-full bg-[#050505] py-40 px-8 md:px-16 lg:px-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative aspect-[4/5] max-w-xl"
        >
          <div className="relative w-full h-full overflow-hidden border border-white/10">
            <motion.img
              src="https://images.unsplash.com/photo-1772529375232-0257bffd472d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080"
            ...
            >
              <p className="text-[#00ff41]/90 text-[0.6rem] tracking-wider uppercase">PORT_03</p>
            </motion.div>
            ...
            <motion.div
              ...
              style={{ backdropFilter: "blur(15px)" }}
            >
              <p className="text-white/70 text-[0.6rem] tracking-wider uppercase">SERIES</p>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute top-1/2 right-6 w-12 h-12 rounded-full border-2 border-[#00ff41] flex items-center justify-center"
            >
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-white/50 text-[0.6rem] tracking-[0.25em] uppercase">PORTRAIT SERIES</span>
          </div>

          {/* Title */}
          <h3
            className="leading-[0.9] tracking-tighter mb-6"
            style={{
          ...
          >
            ...
            <br />
            <span className="text-[#00ff41]">MOOD</span>
          </h3>

          <p className="text-white/60 text-sm leading-relaxed max-w-md">
            Capturing presence through shadow and light. Each frame
            explores the tension between revelation and concealment,
            bringing depth to the editorial narrative.
          </p>

          {/* Info boxes grid with green accents */}
          <div className="grid grid-cols-2 gap-4">
            {[
              { label: "GENRE", value: "EDITORIAL", accent: true },
              { label: "MOOD", value: "DARK", accent: false },
              { label: "SERIES", value: "2026", accent: false },
              { label: "FORMAT", value: "PORTRAIT", accent: true },
            ].map((item, i) => (
              <motion.div
                key={i}
          ...
          <div className="flex flex-wrap gap-2">
            {["Shadow", "Light", "Mood", "Depth"].map((tag, i) => (
              <motion.span
                key={tag}
