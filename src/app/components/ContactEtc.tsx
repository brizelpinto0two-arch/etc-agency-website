...
export function ContactEtc() {
  return (
    <section id="contact" className="relative bg-[#050505] py-32 px-8 md:px-16 lg:px-20 border-t border-white/5 overflow-hidden">

      {/* Brand gradient — CSS, no image download */}
      <div
      ...
      <div className="relative z-10 max-w-5xl">
        ...
        >
          ...
          <br />
          <span className="text-[#CCFF00]"><TextReveal text="More big thoughts." delay={0.7} /></span>
        </motion.h2>
        ...
        >
          <MagneticButton as="a" href="mailto:Ecetera@etc.designlabs.com">
            <div
              className="group flex items-center gap-4 px-6 py-4 border border-white/20 hover:border-[#CCFF00]/60 rounded-full transition-all duration-300 cursor-pointer"
            ...
            >
              ...
              <span className="text-white/80 text-xs tracking-wide" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>Ecetera@etc.designlabs.com</span>
            </div>
          </MagneticButton>

          <MagneticButton as="a" href="tel:+917219889670">
            <div
              className="group flex items-center gap-4 px-6 py-4 border border-white/20 hover:border-[#4040FF]/60 rounded-full transition-all duration-300 cursor-pointer"
              style={{ backdropFilter: "blur(10px)", background: "rgba(255,255,255,0.03)" }}
            >
              <span className="text-white/40 text-[0.55rem] tracking-[0.2em] uppercase group-hover:text-[#4040FF]/80 transition-colors" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>MOBILE</span>
              <span className="text-white/80 text-xs tracking-wide" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>+91 72198 89670</span>
            </div>
          </MagneticButton>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        className="relative z-10 mt-32 pt-8 border-t border-white/5 flex items-end justify-between flex-wrap gap-4"
      >
        <p
