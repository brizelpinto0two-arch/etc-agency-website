      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-white/50 text-[0.6rem] tracking-[0.25em] uppercase">FASHION SERIES</span>
          </div>
          ...
          <p className="text-white/60 text-sm leading-relaxed max-w-md">
            Contemporary portraiture meets editorial vision. Exploring
            identity through lens and light, each frame tells a story
            of urban sophistication and personal narrative.
          </p>

          {/* Info boxes grid with green accents */}
          <div className="grid grid-cols-2 gap-4">
            {[
              { label: "CATEGORY", value: "FASHION", accent: true },
              { label: "STYLE", value: "MODERN", accent: false },
              { label: "YEAR", value: "2026", accent: false },
              { label: "MEDIUM", value: "DIGITAL", accent: true },
            ].map((item, i) => (
              <motion.div
                key={i}
          ...
          <div className="flex flex-wrap gap-2">
            {["Style", "Identity", "Urban", "Vision"].map((tag, i) => (
              <motion.span
                key={tag}
        ...
        >
          <div className="relative w-full h-full overflow-hidden border border-white/10">
            <motion.img
              src="https://images.unsplash.com/photo-1699378999301-8c88a6a237d9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080"
            ...
            >
              <p className="text-[#00ff41]/90 text-[0.6rem] tracking-wider uppercase">LOOK_04</p>
            </motion.div>
            ...
            <motion.div
              ...
              style={{ backdropFilter: "blur(15px)" }}
            >
              <p className="text-white/70 text-[0.6rem] tracking-wider uppercase">FASHION</p>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute bottom-1/3 left-6 w-12 h-12 rounded-full border-2 border-[#00ff41] flex items-center justify-center"
            >
